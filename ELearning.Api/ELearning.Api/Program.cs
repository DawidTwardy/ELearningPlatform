...
{
    new Badge { Name = "Pilny Student", Description = "Ukończono pierwszą lekcję", IconUrl = "student.png", CriteriaType = "LessonCount", CriteriaThreshold = 1 },
    new Badge { Name = "Weteran Nauki", Description = "Ukończono 5 lekcji", IconUrl = "veteran.png", CriteriaType = "LessonCount", CriteriaThreshold = 5 },
    new Badge { Name = "Quiz Master", Description = "Zaliczono 3 quizy", IconUrl = "quiz.png", CriteriaType = "QuizCount", CriteriaThreshold = 3 },
    new Badge { Name = "Systematyczność", Description = "3 dni nauki z rzędu", IconUrl = "streak.png", CriteriaType = "Streak", CriteriaThreshold = 3 },
    new Badge { Name = "Zbieracz Punktów", Description = "Zdobądź 100 punktów", IconUrl = "points100.png", CriteriaType = "Points", CriteriaThreshold = 100 },
    new Badge { Name = "Mistrz Wiedzy", Description = "Zdobądź 500 punktów", IconUrl = "points500.png", CriteriaType = "Points", CriteriaThreshold = 500 }
};
